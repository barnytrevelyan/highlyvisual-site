...
bodyImages:
  - src: "/img/wildlife-amboseli-elephant.jpg"
    alt: "Lone elephant in Amboseli-style landscape with mountain backdrop"
    caption: "The kind of single-subject coverage international productions arrive to capture — and need a fixer to get to."
  - src: "/img/bts-elephants-aerial.jpg"
    alt: "Aerial of elephant herd on dry red earth"
    caption: "Aerial work integrates with international NHU schedules across multiple parks."
order: 7
