...
export const site = {
  ...
  productionHouses: [
    ...
    { name: 'Humble Bee Films',                 logo: '/img/logos/humblebee-films.png' },
    ...
    { name: 'Netflix',                          logo: '/img/logos/netflix.svg' },
    { name: 'Apple TV+',                        logo: '/img/logos/apple-tv.svg' },
    { name: 'Channel 4',                        logo: '/img/logos/channel-4.svg' },
