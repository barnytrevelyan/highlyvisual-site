...
export const credits: Credit[] = [
  ...
  { title: 'Incredible Animal Journeys', productionHouse: 'Plimsoll Productions', distributor: 'National Geographic · Disney+', role: 'Drone Operator', year: '2023', cardImage: '/img/credit-incredible-animal-journeys.webp', url: '/work/incredible-animal-journeys/', lane: 'natural-history' },
  { title: 'Wild Babies', productionHouse: 'Plimsoll Productions', distributor: 'Netflix', role: 'Drone Operator', year: '2022', cardImage: '/img/credit-wild-babies.jpg', url: '/work/wild-babies/', lane: 'natural-history' },
  ...
  { title: 'Queens', productionHouse: 'Wildstar Films', distributor: 'National Geographic · Disney+ · Hulu', role: 'Drone Operator', year: '2024', cardImage: '/img/credit-queens.jpg', lane: 'natural-history' },
  { title: 'Secret World of Sound', productionHouse: 'Humble Bee Films', distributor: 'Sky Original · BBC Earth', role: 'Drone Operator', year: '2024', cardImage: '/img/credit-secret-world-of-sound.jpeg', lane: 'natural-history' },
  { title: 'Africa from Above', productionHouse: 'Off the Fence', role: 'Drone Operator', year: 'Various', cardImage: '/img/credit-africa-from-above.jpg', lane: 'natural-history' },
  { title: 'Earth at Night in Color', productionHouse: 'Offspring Films', distributor: 'Apple TV+ (narrated by Tom Hiddleston)', role: 'Drone Operator', year: '2020', cardImage: '/img/credit-earth-at-night.jpg', lane: 'natural-history' },
  { title: 'Earth from Space', productionHouse: 'BBC Studios Natural History Unit', distributor: 'BBC', role: 'Drone Operator', year: '2019', cardImage: '/img/credit-earth-from-space.jpg', lane: 'natural-history' },
  { title: 'Equator from the Air', productionHouse: 'BBC', distributor: 'BBC', role: 'Aerial cinematography', year: 'Various', cardImage: '/img/credit-equator-from-the-air.jpg', lane: 'natural-history' },
  ...
  { title: 'Prodigies', distributor: 'Apple TV+', role: 'Drone Operator', year: 'Various', cardImage: '/img/credit-prodigies.jpg', lane: 'natural-history' },
  ...
  { title: 'Rendez-vous en terre inconnue', productionHouse: 'France 2', distributor: 'France TV', role: 'Drone Operator (Kenya unit)', year: 'Various', cardImage: '/img/credit-rendezvous.jpg', lane: 'natural-history' },
